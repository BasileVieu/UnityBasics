...
void ShaderGraphFunction_float(float3 _in, out float3 _out, out float4 _fractalColor)
{
    _out = _in;

    _fractalColor = GetFractalColor();
}

void ShaderGraphFunction_half(half3 _in, out half3 _out, out half4 _fractalColor)
{
    _out = _in;
